...
public class ConcurrentRegisterTestTask extends AbstractResourceRegistryConcurrencyTestTask {
    ...
    public ConcurrentRegisterTestTask(AtomicInteger counter,
            ResourceRegistry<Object> resourceRegistry, String keyToUseForRegisteredObject) {
    ...
    public void run() {
        try {
            resourceRegistry.register(keyToUseForRegisteredObject, new Object());
